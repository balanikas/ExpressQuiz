...
namespace ExpressQuiz.Core.Services
{
    public class QuizResultService : IQuizResultService
    {
        ...
        public QuizResultService(IRepo<Quiz> quizRepo, IRepo<QuizResult> quizResultRepo,
            IRepo<QuizRating> quizRatingRepo, IRepo<Question> questionRepo, IRepo<Answer> answerRepo)
        {
            _quizRepo = quizRepo;
        ...
        public int GetRelativeScore(int quizId, int compareValue)
        {
            ...
            var result = (int) ((belowCompareValue/(double) allCount)*100);
        ...
        public QuizStatistics GetStatistics(int quizId)
        {
            ...
            stats.TotalPoints = quiz.AllowPoints ? quiz.Questions.Sum(x => x.Points) : quiz.Questions.Count;
